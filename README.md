...
- atlas - daily operational reports for Atlas devices 2015 to 2021 (raw data)
- figures - generated plots for LITE database
- geodata - IP2Location LITE Country IP geolocation database (free)
- geography - country border maps
- history - created historical dataset
- maps - Atlas coverage maps for countries
- precomp - precomputed historical dataset and IP geolocation
...
To use the commercial database in the notebook, obtain it [here](https://www.ip2location.com/database/ip2location) and edit this code line to replace the free database with commercial version:
...
Due to large data, the processing may take a long time depending on the hardware. Precomputed results are provided to run the notebook quickly. Preprocessed is historical dataset and IP geolocation. By default, precomputed results are used. Set the values to False to process the raw data from scratch.
